...
class View:
    ...
    def load_interface(self):
        ...
        # TODO
        self.cammino_minimo_btn= ft.ElevatedButton(text="Cammino Minimo", width=200, on_click=self.controller.handle_cammino_minimo)
        self.lista_visualizzazione_3= ft.ListView(expand=1, spacing=20, padding=20, auto_scroll=False)
